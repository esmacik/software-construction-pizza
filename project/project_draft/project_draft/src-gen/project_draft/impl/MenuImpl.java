 ...
 * </p>
 * <ul>
 *   <li>{@link project_draft.impl.MenuImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MenuImpl extends MinimalEObjectImpl.Container implements Menu {
	...
	protected EClass eStaticClass() {
		return Project_draftPackage.Literals.MENU;
	}
	...
	public EList<Item> getItems() {
		if (items == null) {
			items = new EObjectResolvingEList<Item>(Item.class, this, Project_draftPackage.MENU__ITEMS);
		}
		return items;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Project_draftPackage.MENU__ITEMS:
			return getItems();
		}
