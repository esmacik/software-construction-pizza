 ...
 * @generated
 */
public class Project_draftSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Project_draftPackage.DELIVERY: {
			...
			if (result == null)
				result = caseOrder(delivery);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Project_draftPackage.DINE_IN: {
			DineIn dineIn = (DineIn) theEObject;
			T result = caseDineIn(dineIn);
			if (result == null)
				result = caseOrder(dineIn);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Project_draftPackage.CARRY_OUT: {
			CarryOut carryOut = (CarryOut) theEObject;
			T result = caseCarryOut(carryOut);
			if (result == null)
				result = caseOrder(carryOut);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case Project_draftPackage.DRIVER: {
			...
			if (result == null)
				result = caseEmployee(driver);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Project_draftPackage.BRANCH_MANAGER: {
			BranchManager branchManager = (BranchManager) theEObject;
			T result = caseBranchManager(branchManager);
			if (result == null)
				result = caseEmployee(branchManager);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Project_draftPackage.TEAM_MEMBER: {
			...
			if (result == null)
				result = caseEmployee(teamMember);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dine In</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dine In</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDineIn(DineIn object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Carry Out</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Carry Out</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCarryOut(CarryOut object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Branch Manager</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Branch Manager</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBranchManager(BranchManager object) {
		return null;
	}
